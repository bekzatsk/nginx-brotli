...
RUN \
	...
	&& install -m755 objs/ngx_http_brotli_filter_module-debug.so /usr/lib/nginx/modules/ngx_http_brotli_filter_module-debug.so \
	&& install -m755 objs/ngx_http_brotli_static_module-debug.so /usr/lib/nginx/modules/ngx_http_brotli_static_module-debug.so \
